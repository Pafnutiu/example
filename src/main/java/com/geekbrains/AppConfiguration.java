    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.geekbrains");
                servletContext.setInitParameter("tapestry.development-modules", "com.geekbrains.services.DevelopmentModule");
